<template>
    <!-- Alert Msg -->
    <div v-show="reg_show_alert" :class="reg_alert_variant"
        class="text-white text-center px-4 py-2 border-0 rounded relative mb-4">
        <span class="inline-block align-middle mr-8">{{ reg_alert_msg }}</span>
        <button @click="reg_show_alert = false"
    ...
    <vee-form :validation-schema="schema" @submit="register" :initial-values="userData">
        ...
        <div class="mb-3">
            ...
            <!-- name property should have the name of the field of which will contain the error message -->
        ...
        <div class="mb-3">
            ...
            <!-- bails property is used to validate all the fields at once -->
    ...
    data() {
        return {
            ...
            schema: {
                ...
                age: 'required|numeric|min_value:18|max_value:101',
